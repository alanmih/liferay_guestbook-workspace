...
//		ServiceContext serviceContext = ServiceContextFactory.getInstance(GuestbookEntry.class.getName(), request);
	...
	//TODO [Issue to be checked] All usage of classes in either guestbook-api or guestbook-service in the Following render method will fail the guestbook app
...
//	private GuestbookLocalService _guestbookLocalService;
	private GuestbookEntryLocalServiceUtil _guestbookLocalService;
